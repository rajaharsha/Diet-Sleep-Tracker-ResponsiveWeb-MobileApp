    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <form class="navbar-form navbar-right" id="signin" method ="post" action="login_validation.php">
            ...
            <button type="submit" class="btn btn-success" value="login_button" id="login_button">Sign in</button>
